...
export const personalPage: Record<Language, PersonalPageContent> = {
  pt: {
    ...
    pricing: {
      eyebrow: 'Preço',
      title: 'O sistema é seu. Você paga só pelo WhatsApp.',
      description:
        'Toda conta Horarius tem o painel completo de graça. O assistente no WhatsApp é a única coisa com preço — e você testa 14 dias antes de decidir.',
      free: {
        name: 'Grátis',
        price: 'R$ 0',
        period: 'para sempre',
        description: 'O painel completo, para toda conta Horarius.',
        features: [
          'Painel no navegador e no celular',
          'Lançamentos, tarefas e notas na mão',
          'Resumo do mês, categorias e “Guardado”',
      ...
      paid: {
        ...
        features: [
          'Conversa ilimitada com o assistente',
          'Áudio vira lançamento, tarefa ou lembrete',
          '100 lembretes proativos por mês',
  ...
  en: {
    ...
    pricing: {
      eyebrow: 'Pricing',
      title: 'The system is yours. You only pay for WhatsApp.',
      description:
        'Every Horarius account gets the full panel for free. The WhatsApp assistant is the only thing with a price — and you try it for 14 days before deciding.',
      free: {
        name: 'Free',
        price: 'R$ 0',
        period: 'forever',
        description: 'The full panel, for every Horarius account.',
        features: [
          'Panel in the browser and on your phone',
          'Entries, tasks and notes by hand',
          'Monthly summary, categories and “Saved”',
      ...
      paid: {
        ...
        features: [
          'Unlimited conversation with the assistant',
          'Voice notes become entries, tasks or reminders',
          '100 proactive reminders per month',
  ...
  es: {
    ...
    pricing: {
      eyebrow: 'Precio',
      title: 'El sistema es tuyo. Solo pagas por WhatsApp.',
      description:
        'Toda cuenta Horarius tiene el panel completo gratis. El asistente en WhatsApp es lo único con precio — y lo pruebas 14 días antes de decidir.',
      free: {
        name: 'Gratis',
        price: 'R$ 0',
        period: 'para siempre',
        description: 'El panel completo, para toda cuenta Horarius.',
        features: [
          'Panel en el navegador y en el celular',
          'Registros, tareas y notas a mano',
          'Resumen del mes, categorías y “Guardado”',
      ...
      paid: {
        ...
        features: [
          'Conversación ilimitada con el asistente',
          'El audio se vuelve registro, tarea o recordatorio',
          '100 recordatorios proactivos por mes',
