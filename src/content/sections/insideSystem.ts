    ...
    screens: {
      ...
      reviews: {
        ...
        mock: {
          ...
          tableTitle: 'Avaliações recebidas',
          columns: ['Cliente', 'Nota', 'Comentário', 'Serviço', 'Profissional', 'Atendimento'],
          ...
          rows: [
            ...
            { client: 'Paula H.', stars: 4, service: 1, professional: 'Marina', date: '08/08 09:30' },
            {
              client: 'Renan D.',
              stars: 5,
    ...
    screens: {
      ...
      reviews: {
        ...
        mock: {
          ...
          tableTitle: 'Reviews received',
          columns: ['Client', 'Rating', 'Comment', 'Service', 'Professional', 'Visit'],
          noComment: 'No comment',
          rows: [
            {
              client: 'Liam B.',
              stars: 5,
              comment: '“Flawless service.”',
              service: 0,
              professional: 'Ryan',
              date: '08/08 14:00',
            },
            { client: 'Ava T.', stars: 4, service: 1, professional: 'Mia', date: '08/08 09:30' },
            {
              client: 'Noah S.',
              stars: 5,
              comment: '“I’ll definitely be back.”',
              service: 0,
              professional: 'Zoe',
              date: '07/08 16:00',
            },
    ...
    screens: {
      ...
      reviews: {
        ...
        mock: {
          ...
          tableTitle: 'Reseñas recibidas',
          columns: ['Cliente', 'Nota', 'Comentario', 'Servicio', 'Profesional', 'Atención'],
          noComment: 'Sin comentario',
          rows: [
            {
              client: 'Diego M.',
              stars: 5,
              comment: '“Atención impecable.”',
              service: 0,
              professional: 'Mateo',
              date: '08/08 14:00',
            },
            { client: 'Valentina T.', stars: 4, service: 1, professional: 'Lucía', date: '08/08 09:30' },
            {
              client: 'Andrés F.',
              stars: 5,
              comment: '“Sin duda vuelvo.”',
              service: 0,
              professional: 'Sofía',
              date: '07/08 16:00',
            },
            {
              client: 'Bianca L.',
              stars: 5,
              comment: '“¡Me encantó el resultado!”',
              service: 1,
              professional: 'Lucía',
              date: '06/08 11:15',
            },
